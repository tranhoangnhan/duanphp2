        ...
        <div class="main_dangky row buocdem_xl">
         <div class="dangky_left">
             ...
             <div class="Email_dangky">
                 ...
                 <input type="text" name="email" class="input_name input_dangky">
             </div>
 
             <div class="Email_dangky">
                 <label for="" class="text_email" name="password">Mật khẩu <sub class="sao">*</sub></label>
                 <input type="password" class="input_name input_dangky">
             </div>
 
             <div class="Email_dangky fl">
             ...
             <div class="Email_dangky can_giua">
                 <button type="submit" name="login" class="btn_dangky_user dangky_user">ĐĂNG NHẬP </button>
             </div>
             ...
             <div class="dangky_right">
                 <div class="text_right">
                     <h1>Khách hàng đăng ký mới</h1>
                 <p>Bằng cách tạo tài khoản với Vua Hàng Hiệu, bạn sẽ có thể di chuyển qua quy trình <strong>thanh toán nhanh hơn, lưu trữ nhiều địa chỉ giao hàng</strong>, xem và theo dõi đơn hàng của bạn trong tài khoản của bạn và hơn thế nữa.</p>
             <button class="tieptuc_muahang bnt_tinhtien bnt_dangky"><a href="./dangky.html">ĐĂNG KÝ NGAY</a> </button>    
             </div>
