   ...
   <table class="table table-bordered">
    ...
    <th>Tên sản phẩm</th>
      ...
      <td><input class="form-control" type="text" name="ma_sp" value="<?php echo $sp["ma_sp"]?>" disabled></td>
        <td><input class="form-control" type="text" name="ten_sp" value="<?php echo $sp["ten_sp"]?>" required	></td>
        <td><input class="form-control" type="text" name="gia" value="<?php echo $sp["gia"]?>" required	></td>
        <td><input class="form-control" type="text" name="gia_km" value="<?php echo $sp["gia_km"]?>" required	></td>
        <td><input class="form-control" type="text" name="so_luong" value="<?php echo $sp["so_luong"]?>" required	></td>
        ...
        <td><input class="form-control" type="text" name="ngay_nhap" value="<?php echo $sp["ngay_nhap"]?>" required	></td>
       
      </td>
      </tr>
  <td colspan = "7">
    <label for="">Mô tả</label>  
    <textarea name="mo_ta" class="form-control ckeditor"  cols='12' rows='12' id="" required	><?=$sp['mo_ta']?></textarea></td>
