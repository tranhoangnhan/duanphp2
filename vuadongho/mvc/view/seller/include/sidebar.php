...
<html lang="en">
  <head>
    ...
    <base href="http://localhost/vuadongho/">
    ...
    />
    <link
      href="./public/seller/vendor/fontawesome-free/css/all.min.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
    ...
    <link href="./public/seller/css/sb-admin-2.min.css" rel="stylesheet" />
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      >
        ...
        <li class="nav-item">
          <a class="nav-link" href="seller/product_list">
        ...
        <!-- Nav Item - Charts -->
        <li class="nav-item">
          <a class="nav-link" href="seller/product_add">
                ...
                >
                  ...
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                      <img
                        ...
                        src="./public/seller/img/undraw_profile_1.svg"
                        alt="..."
                      />
                  ...
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                      <img
                        class="rounded-circle"
                        src="./public/seller/img/undraw_profile_2.svg"
                        alt="..."
                      />
                  ...
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image mr-3">
                      <img
                        class="rounded-circle"
                        src="./public/seller/img/undraw_profile_3.svg"
                        alt="..."
                      />
              ...
              <li class="nav-item dropdown no-arrow">
                ...
                >
                  ...
                  <img
                    ...
                    src="./public/seller/img/undraw_profile.svg"
                  />
                </a>
